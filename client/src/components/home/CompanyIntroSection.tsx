    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
          {/* ====================================================
              LEFT COLUMN: Company Introduction Content
          ==================================================== */}
          <div className="space-y-8 lg:col-span-7">
            {/* Small Top Label */}
            <div className="inline-flex items-center gap-2.5 rounded-full border border-sky-200 bg-sky-50 px-3.5 py-1 text-xs font-bold tracking-widest text-[#0B192C] uppercase shadow-sm">
              <span className="h-2 w-2 rounded-full bg-brand-orange shadow-[0_0_6px_#ea580c]" />
              About AXION PackTech
            </div>

            {/* Main Heading */}
            <h2 className="text-3xl font-extrabold tracking-tight text-[#0B192C] sm:text-4xl lg:text-5xl leading-[1.15]">
            ...
            <p className="max-w-2xl text-base font-normal leading-relaxed text-slate-600 sm:text-lg">
              AXION PackTech delivers reliable packaging, bagging and automation
              solutions engineered for modern industrial requirements. We
              combine precision engineering, innovative technology and customized
              solutions to help businesses improve efficiency, maximize line
              throughput, and build smarter production systems.
            </p>

            {/* Company Highlights (3 Items) */}
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 pt-2">
              {/* Highlight 01 */}
              <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:border-sky-300 hover:shadow-md">
                <span className="text-xs font-bold tracking-wider text-brand-orange">
                  01
                </span>
                <h3 className="mt-2 text-base font-bold text-[#0B192C]">
                  Precision Engineering
                </h3>
                <p className="mt-1 text-xs text-slate-500 leading-relaxed">
                  High-tolerance machinery built for continuous, heavy-duty industrial cycles.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:border-sky-300 hover:shadow-md">
                ...
                <p className="mt-1 text-xs text-slate-500 leading-relaxed">
                  Tailored bagging and handling systems configured to exact plant workflows.
                </p>
              </div>

              {/* Highlight 03 */}
              <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:border-sky-300 hover:shadow-md">
                <span className="text-xs font-bold tracking-wider text-[#0B192C]">
                  03
                </span>
                <h3 className="mt-2 text-base font-bold text-[#0B192C]">
                ...
                <p className="mt-1 text-xs text-slate-500 leading-relaxed">
                  Intelligent PLC controls, end-of-line robotics, and seamless line integration.
                </p>
              </div>
            </div>
            ...
            <div className="pt-2">
              <Link
                href="/about-us"
                className="group inline-flex items-center gap-3 rounded-xl bg-brand-orange px-7 py-3.5 text-sm font-semibold text-white shadow-md shadow-orange-950/20 transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-orange-light hover:shadow-lg hover:shadow-orange-600/25 active:scale-95"
              >
          ...
          {/* ====================================================
              RIGHT COLUMN: Premium Industrial Visual Area
          ==================================================== */}
            ...
            <div className="relative rounded-3xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-[0_20px_50px_-15px_rgba(2,132,199,0.12)]">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs font-semibold tracking-wider text-slate-700 uppercase">
                    SYSTEM SPEC // AP-AUTO-SERIES
                  </span>
                </div>
                <span className="rounded-full bg-slate-100 px-2.5 py-0.5 font-mono text-[10px] font-medium text-slate-600">
                  REV 2.4
                </span>
              </div>

              {/* Technical SVG Blueprint Illustration */}
              <div className="relative my-6 flex items-center justify-center rounded-2xl bg-gradient-to-b from-slate-900 to-[#061527] p-6 text-white overflow-hidden shadow-inner">
                ...
                <svg
                  className="relative z-10 h-48 w-full max-w-[280px]"
                  viewBox="0 0 280 200"
                  fill="none"
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div className="rounded-xl border border-slate-100 bg-slate-50/80 p-3">
                  ...
                  <p className="mt-0.5 font-mono text-lg font-extrabold text-[#0B192C]">
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50/80 p-3">
                  ...
                  <p className="mt-0.5 font-mono text-lg font-extrabold text-[#0B192C]">
                    1,200 <span className="text-xs font-sans text-slate-500">Bags/Hr</span>
                  </p>
                </div>
              </div>

              {/* Engineering Certification Pill */}
              <div className="mt-4 flex items-center justify-between rounded-xl bg-sky-50/80 px-4 py-2 text-xs text-sky-900 border border-sky-200/60">
                <span className="font-semibold">Automation Architecture</span>
                <span className="font-mono text-[11px] text-sky-700">PLC &amp; HMI INTEGRATED</span>
              </div>
            </div>
          </div>
        </div>
